        ...
        while(sc.hasNextLine()) {
            ...
            if (opcion == 0) { //endarrera
                ...
                if (rival == 0) { //rival
                    ...
                    Rook p = new Rook(true, new Pair<Integer, Integer>(2, 0));
                    ...
                    Rook p = new Rook(true, new Pair<Integer, Integer>(2, 3));
                    ...
                    StubTaulellRook st_cas1 = new StubTaulellRook("rnbqk1nr/pppppp2/3R4/6pp/3b3P/8/PPPPPP2/RNBQKBN1 b Qkq - 2 1");
                    Rook p = new Rook(false, new Pair<Integer, Integer>(2, 3));
                ...
                if (rival == 0) { //rival
                    ...
                    Rook p = new Rook(false, new Pair<Integer, Integer>(4, 3));
                ...
                if (rival == 0) { //rival
                    ...
                    Rook p = new Rook(false, new Pair<Integer, Integer>(4, 4));
                ...
                if (rival == 0) { //rival
                    ...
                    Rook p = new Rook(false, new Pair<Integer, Integer>(3, 7));
                    ...
                    Rook p = new Rook(false, new Pair<Integer, Integer>(1, 7));
                    ...
                    Rook p = new Rook(false, new Pair<Integer, Integer>(0, 7));
